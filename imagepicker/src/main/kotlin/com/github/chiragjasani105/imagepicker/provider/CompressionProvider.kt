package com.github.chiragjasani105.imagepicker.provider
...
import com.github.chiragjasani105.imagepicker.ImagePickerActivity
import com.github.chiragjasani105.imagepicker.util.ExifDataCopier
import com.github.chiragjasani105.imagepicker.util.FileUtil
import com.github.chiragjasani105.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.chiragjasani105.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
