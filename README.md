...
<div align="center">
  <sub>Built with ❤︎ by
  <a href="https://twitter.com/@ChiragJasani5">Chirag Jasani</a> and
  <a href="https://github.com/chiragjasani/ImagePicker-Smart/graphs/contributors">
    contributors
  </a>
</div>
<br/>
...
1. Gradle dependency:
    ...
    ```groovy
   implementation 'com.github.chiragjasani105:imagepicker:2.1'
    ```

   **If you are yet to Migrate on AndroidX, Use support build artifact:**
   ```groovy
   implementation 'com.github.chiragjasani105:imagepicker-support:1.7.1'
    ```
...
We'll be really happy if you sent us links to your projects where you use our component. Just send an email to **jasani.chirag105@gmail.com** And do let us know if you have any questions or suggestion regarding the library.
